...
class CnmedicineModel(db.Model):
    __tablename__ = 'renji_cnmedicine'
    MedicineID = db.Column(db.String(36), primary_key=True, comment='检查ID')
    MedicineName = db.Column(db.String(100), comment='中药名称')
    MedicineType = db.Column(db.String(100), comment='中药类型')
